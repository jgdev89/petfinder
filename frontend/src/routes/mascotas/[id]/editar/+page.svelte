...
{:else}
  <main class="max-w-xl mx-auto px-4 py-8">
    ...
    <a href="/mascotas/{page.params.id}" class="text-gray-400 hover:text-orange-500 text-sm no-underline transition-colors">← Volver al detalle</a>

    <h1 class="text-2xl font-bold text-gray-800 mt-4 mb-6">Editar publicación</h1>
    ...
    <div class="border border-gray-100 rounded-xl p-4 mb-6">
      <h2 class="text-sm font-semibold text-gray-700 mb-3">Fotos</h2>
      ...
      {:else}
        <p class="text-xs text-gray-400 mb-3">Sin fotos todavía.</p>
      {/if}
