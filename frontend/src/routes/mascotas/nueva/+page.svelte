  ...
  <div class="flex flex-col gap-5">
    ...
    <div class="flex flex-col gap-1">
      <label
        for="nombre"
        class="text-sm font-semibold text-gray-700 dark:text-gray-200"
        >Nombre <span class="text-gray-400 font-normal">(opcional)</span></label
      >
      <input
        id="nombre"
        type="text"
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="flex flex-col gap-1">
        <label
          for="raza"
          class="text-sm font-semibold text-gray-700 dark:text-gray-200"
          >Raza <span class="text-gray-400 font-normal">(opcional)</span></label
        >
        <input
          id="raza"
          type="text"
    ...
    <div class="flex flex-col gap-1">
      <label
        for="fecha_suceso"
        class="text-sm font-semibold text-gray-700 dark:text-gray-200"
        >Fecha del suceso <span class="text-red-400 font-normal">*</span></label
      >
      <input
        id="fecha_suceso"
        type="date"
    ...
    <div class="flex flex-col gap-1">
      <label
        for="imagen"
        class="text-sm font-semibold text-gray-700 dark:text-gray-200"
        >Foto <span class="text-gray-400 font-normal">(opcional)</span></label
      >
      <input
        id="imagen"
        type="file"
