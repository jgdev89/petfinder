...
<main class="max-w-xl mx-auto px-4 py-8">
  <a href="/" class="text-gray-400 hover:text-orange-500 text-sm no-underline transition-colors">
    ← Volver al listado
  </a>
  ...
  <div class="flex flex-col gap-5">
    ...
    <div class="flex flex-col gap-1">
      <label for="especie" class="text-sm font-semibold text-gray-700">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="flex flex-col gap-1">
        <label for="raza" class="text-sm font-semibold text-gray-700">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="flex flex-col gap-1">
        <label for="localidad" class="text-sm font-semibold text-gray-700">
      ...
      <div class="flex flex-col gap-1">
        <label for="provincia" class="text-sm font-semibold text-gray-700">
    ...
    <!-- Fecha -->
    <div class="flex flex-col gap-1">
      <label for="fecha_suceso" class="text-sm font-semibold text-gray-700">
    ...
    <!-- Foto -->
    <div class="flex flex-col gap-1">
      <label for="imagen" class="text-sm font-semibold text-gray-700">
